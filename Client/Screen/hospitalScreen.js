...
import { Text, View, Button, Image, SafeAreaView, StyleSheet, TouchableOpacity, Linking, ScrollView } from 'react-native';
            ...
            <SafeAreaView style={styles.infoContainer}>
                <ScrollView>
                    <View style={styles.textContainer}>
                        <Text style={styles.nameStyle}>{route.params.data.hospital_name}</Text>
                        <Text style={styles.otherTextStyle}>Tel: {route.params.data.phone}</Text>
                        <Text style={styles.otherTextStyle}>지번주소: {route.params.data.addr_basic}</Text>
                        <Text style={styles.otherTextStyle}>도로명주소: {route.params.data.addr_st}</Text>
                    </View>

                    <View style={styles.telIconContainer}>
                        <TouchableOpacity style={styles.touchContainer} onPress={() => { Linking.openURL(`tel:${route.params.data.phone}`) }}>
                        ...
                        <TouchableOpacity style={styles.touchContainer} onPress={kakaoShare}>
                            <View style={styles.touchViewContainer}>
